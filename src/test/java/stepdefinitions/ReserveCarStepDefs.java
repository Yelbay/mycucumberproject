...
//       defaultPage.continueReservationButton.click();
    ...
    public void user_enters_card_number(String string) {
        Driver.waitAndSendText(paymentPage.cardNumber,string);
    }
    ...
    public void user_enters_and(String expire_date, String CVC) {
        Driver.waitAndSendText(paymentPage.expireDate,expire_date);
        Driver.waitAndSendText(paymentPage.CVC,CVC);
    }
